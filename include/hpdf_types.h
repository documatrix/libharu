...
typedef enum _HPDF_PageTabOrder {
    HPDF_PAGE_TAB_ORDER_ROW = 0,
    HPDF_PAGE_TAB_ORDER_COLUMN,
    HPDF_PAGE_TAB_ORDER_STRUCTURE
} HPDF_PageTabOrder;
...
typedef enum _HPDF_ArtifactType {
    HPDF_ARTIFACT_PAGINATION = 0,
    HPDF_ARTIFACT_LAYOUT,
    HPDF_ARTIFACT_PAGE,
    HPDF_ARTIFACT_BACKGROUND
} HPDF_ArtifactType;

typedef enum _HPDF_ArtifactSubtype {
    HPDF_ARTIFACT_HEADER = 0,
    HPDF_ARTIFACT_FOOTER,
    HPDF_ARTIFACT_WATERMARK
} HPDF_ArtifactSubtype;

typedef enum _HPDF_StructureType {
    HPDF_STRUCTURE_TYPE_DOCUMENT = 0,
    HPDF_STRUCTURE_TYPE_PART,
    HPDF_STRUCTURE_TYPE_ART,
    HPDF_STRUCTURE_TYPE_SECT,
    HPDF_STRUCTURE_TYPE_DIV,
    HPDF_STRUCTURE_TYPE_BLOCK_QUOTE,
    HPDF_STRUCTURE_TYPE_CAPTION,
    HPDF_STRUCTURE_TYPE_TOC,
    HPDF_STRUCTURE_TYPE_TOCI,
    HPDF_STRUCTURE_TYPE_INDEX,
    HPDF_STRUCTURE_TYPE_NON_STRUCT,
    HPDF_STRUCTURE_TYPE_PRIVATE,
    HPDF_STRUCTURE_TYPE_HEADING,
    HPDF_STRUCTURE_TYPE_HEADING_1,
    HPDF_STRUCTURE_TYPE_HEADING_2,
    HPDF_STRUCTURE_TYPE_HEADING_3,
    HPDF_STRUCTURE_TYPE_HEADING_4,
    HPDF_STRUCTURE_TYPE_HEADING_5,
    HPDF_STRUCTURE_TYPE_HEADING_6,
    HPDF_STRUCTURE_TYPE_PARAGRAPH,
    HPDF_STRUCTURE_TYPE_LIST,
    HPDF_STRUCTURE_TYPE_LIST_ITEM,
    HPDF_STRUCTURE_TYPE_LIST_LABEL,
    HPDF_STRUCTURE_TYPE_LIST_BODY,
    HPDF_STRUCTURE_TYPE_TABLE,
    HPDF_STRUCTURE_TYPE_TABLE_ROW,
    HPDF_STRUCTURE_TYPE_TABLE_HEADER_CELL,
    HPDF_STRUCTURE_TYPE_TABLE_DATA_CELL,
    HPDF_STRUCTURE_TYPE_TABLE_HEADER_GROUP,
    HPDF_STRUCTURE_TYPE_TABLE_BODY_GROUP,
    HPDF_STRUCTURE_TYPE_TABLE_FOOTER_GROUP,
    HPDF_STRUCTURE_TYPE_SPAN,
    HPDF_STRUCTURE_TYPE_QUOTE,
    HPDF_STRUCTURE_TYPE_NOTE,
    HPDF_STRUCTURE_TYPE_REFERENCE,
    HPDF_STRUCTURE_TYPE_BIB_ENTRY,
    HPDF_STRUCTURE_TYPE_CODE,
    HPDF_STRUCTURE_TYPE_LINK,
    HPDF_STRUCTURE_TYPE_ANNOT,
    HPDF_STRUCTURE_TYPE_RUBY,
    HPDF_STRUCTURE_TYPE_WARICHU,
    HPDF_STRUCTURE_TYPE_FIGURE,
    HPDF_STRUCTURE_TYPE_FORMULA,
    HPDF_STRUCTURE_TYPE_FORM
} HPDF_StructureType;

typedef enum _HPDF_TableHeaderCellScope {
    HPDF_TABLE_HEADER_CELL_SCOPE_ROW = 0,
    HPDF_TABLE_HEADER_CELL_SCOPE_COLUMN,
    HPDF_TABLE_HEADER_CELL_SCOPE_BOTH
} HPDF_TableHeaderCellScope;

typedef enum _HPDF_Placement {
    HPDF_PLACEMENT_BLOCK = 0,
    HPDF_PLACEMENT_INLINE,
    HPDF_PLACEMENT_BEFORE,
    HPDF_PLACEMENT_START,
    HPDF_PLACEMENT_END
} HPDF_Placement;
